...
import { Swipe, SwipeItem } from 'akc-ui';
...
```html
<mx-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
...
export default {
  setup() {
    const images = [
      'https://fastly.jsdelivr.net/npm/@akc-ui/assets/apple-1.jpeg',
      'https://fastly.jsdelivr.net/npm/@akc-ui/assets/apple-2.jpeg',
    ];
    return { images };
  },
};
...
```html
<mx-swipe style="height: 200px;" vertical>
  <mx-swipe-item>1</mx-swipe-item>
  <mx-swipe-item>2</mx-swipe-item>
  <mx-swipe-item>3</mx-swipe-item>
  <mx-swipe-item>4</mx-swipe-item>
...
```ts
import type { SwipeProps, SwipeInstance, SwipeToOptions } from 'akc-ui';
```
...
```ts
import { ref } from 'vue';
import type { SwipeInstance } from 'akc-ui';
...
```html
<mx-swipe v-show="show" ref="swipe" />
```
